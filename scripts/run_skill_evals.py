...
REQUIRED_BY_CASE = {
    ...
    "paper_reproduction_version.md": [
        ...
        "scripts/aspect-yuan reproduce inspect",
        "scripts/detect_aspect_reproduction_context.py",
        "scripts/install_aspect_version.sh",
        "scripts/run_aspect_case.sh",
        "scripts/check_aspect_log.py",
    ],
    "paper_reproduction_profiles.md": [
        "scripts/aspect-yuan reproduce catalog",
        "scripts/aspect-yuan reproduce template kaili-rift",
        "scripts/aspect-yuan reproduce template oneill-hadean-mixing",
        "scripts/aspect-yuan reproduce template gernon-craton-breakup",
        "scripts/aspect-yuan reproduce inspect",
        "SMOKE_TEST_PLAN.md",
        "VERSION_PLAN.md",
